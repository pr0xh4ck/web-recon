...
- [Bagley](https://github.com/bbhunter/Bagley) - Final project for Computer Engineering Degree at UCM. Automated web vulnerability detection system for bug bounty environments.
